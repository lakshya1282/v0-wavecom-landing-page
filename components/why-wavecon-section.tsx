...
export function WhyWaveconSection() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-base md:text-lg text-sky-800 font-bold leading-relaxed">
              At Wavecon, we are committed to revolutionizing the cooling industry with innovative, sustainable solutions that prioritize both performance and environmental responsibility.
            </p>
            ...
            <p className="text-base md:text-lg text-emerald-600 font-bold leading-relaxed pt-4">
              Choose Wavecon for cooling solutions that are smart, sustainable, and built to last.
            </p>
              </div>
            </div>
          </div>
