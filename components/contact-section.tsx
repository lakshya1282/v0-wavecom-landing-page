...
/* Keep old form JSX below for reference - can be deleted */
/*
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      />
                      {errors.company && <p className="text-red-500 text-sm mt-1 font-semibold">{errors.company}</p>}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      {errors.country && <p className="text-red-500 text-sm mt-1 font-semibold">{errors.country}</p>}
                    </div>
                    <div className="flex gap-2">
                      <input
                        type="text"
                        value={selectedCountry?.phone || "+91"}
                        disabled
                        className="w-20 px-3 py-3 border border-gray-300 rounded-lg bg-gray-100 text-gray-900 font-semibold text-center"
                      />
                      <input
                        type="tel"
                        name="phone"
                  ...
                  <div>
                    ...
                    {errors.industry && <p className="text-red-500 text-sm mt-1 font-semibold">{errors.industry}</p>}
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-lime-400 hover:bg-lime-500 text-gray-900 font-bold text-lg py-3 rounded-full transition-all duration-300 hover:shadow-lg"
                  >
                    Send
                  </button>

                  {/* Success Message */}
                  <p className="text-center text-gray-600 italic font-semibold">
                    We will get back to you shortly.
                  </p>
                </form>
              </div>
